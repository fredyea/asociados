      ...
      <TableBody items={datos}>
        {(item) => (
          <TableRow key={item.id_contrato}>
              ...
              <TableCell style={{ textAlign: 'center' }}>
                    <Button onPress={() => {
                          handlenuevaactividad(item.id_contrato);
...
<div className="flex gap-4">
  ...
  <div className="flex flex-col gap-2 flex-[25%]">
    ...
    <Modal isOpen={isOpenModal4} onOpenChange={onOpenChangeModal4} size="4xl">
      <ModalContent>
        {(onClose) => (
          <>
      ...
      <TableHeader>
        ...
        <TableColumn style={{ backgroundColor: '#3F8E96', color: 'white' }}>Fechas</TableColumn>
      ...
      <TableBody items={itemsactividades}>
        {(item) => (
          <TableRow key={item.mi_id}>
              <TableCell>{item.consecutivo}</TableCell>
              <TableCell>{item.fecha_desde}</TableCell>
